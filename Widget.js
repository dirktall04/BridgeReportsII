define(['dojo/_base/declare',
  ...
  function(declare, lang, _BaseWidget, InfoTemplate, Map, EsriLayer, GraphicsLayer,
    ...
    return declare([_BaseWidget, _TemplatedMixin, _WidgetsInTemplatedMixin], {
      ...
      _bridgeWebiLink1stPart: null,
      _bridgeWebiLink2ndPart: null,
      _bridgeWebiLink3rdPart: null,
      _bridgeWebiLinkBase: null,
      _mapFeature: null,
      _featureItemsLayer: null,
      _selectionMode: null,
      _featureItemsSelectionToolbar: null,
      _featureItemsSelectQuery: null,
      _bridgeMarkerSymbol: null,
      _bridgeMarkerRenderer: null,
      _bridgeMarkerSymbol1: null,
      _bridgeMarkerSymbol2: null,
      ...
      // this._bridgeFeatureLayer -- as that is what is used in the
      ...
      // Rename these from *Bridges to *Features in order
      ...
      _initFeatureItemsSelectToolbar: function () {
        ...
        console.log("initting Bridge Selection Toolbar.");
      ...
      _selectionComplete: function (geometry) {
        ...
        //// possibly use this._bridgeFeaturelayer.onSelectionComplete --
        ////featureArray = this._bridgeFeatureLayer.getSelectedFeatures()
      ...
      _showReportLinkForSelectedFeatureItems: function (event) {
        ...
        console.log(this._bridgeWebiLinkBase);
      ...
      _addSelectedFeaturesToTheMap: function(evt) {
        ...
        // Skipped for now.
        // //var featureItemsContent = "<b>Bridge ID</b>: ${BRIDGE_ID}";
